...
class RegisterTab extends Component {
    ...
    getImageFromGallery = async () => {
        ...
        const mediaLibraryPermissions = await Permissions.getAsync(Permissions.MEDIA_LIBRARY);

            if (cameraPermissions.status === 'granted' && cameraRollPermissions.status === 'granted' && mediaLibraryPermissions.status === 'granted') {
